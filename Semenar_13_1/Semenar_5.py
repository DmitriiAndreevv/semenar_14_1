import json
from Semenar_4 import User
from Semenar_3 import AccessException, LevelException
...
if __name__ == '__main__':
    ...
    # print(project)
    with project:
        project.login('006', 'Иван')
        print(f'Admin --- > {project.admin}')
        project.add_user('010', 'Олег', '7')
        print(*project.users)
        user_del = User('010', 'Андрей', '7')
